...
RSpec.describe 'the veterinarian update' do
  it "shows the veterinarian edit form" do
    shelter = Shelter.create(name: 'Hollywood shelter', address: '383 Star Street', city: 'Irvine CA', zip_code: '92046', foster_program: false, rank: 7)
  ...
  context "given valid data" do
    it "submits the edit form and updates the veterinarian" do
      shelter = Shelter.create(name: 'Heavenly pets', address: '46476 South Street', city: 'Aurora CO', zip_code: '80046', foster_program: true, rank: 7)
  ...
  context "given invalid data" do
    it 're-renders the edit form' do
      shelter = Shelter.create(name: 'Heavenly pets', address: '46476 South Street', city: 'Aurora CO', zip_code: '80046', foster_program: false, rank: 7)
